...
import { z } from "zod";
import { markInstalled } from "../../lib/installation/install-state.js";
import { resetDb } from "../../lib/database/db.js";
...
import {
  ...
  isLoopbackAddress,
  tokenMatches,
} from "../../lib/installation/install-token.js";
import { getJustflowsVersion } from "../../lib/runtime/version.js";
import { SiteUrlSchema } from "../../lib/settings/site-url.js";
import { freshInstallSiteSettings, parseInstallLocale, siteSettingsInsertSql } from "../../lib/installation/install-defaults.js";
import { sendInstallDetailsMail } from "../../lib/installation/install-mail.js";
...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    resetDb();
    await sql.close();
    await (await import("../../lib/plugins/plugin-runtime.js")).ensurePluginRuntime();
    await (await import("../../lib/search/search-db.js")).startSearchIndex(siteId);
