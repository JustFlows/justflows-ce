...
import { DEFAULT_COMMENT_SETTINGS, type CommentSettings } from "../../../src/lib/comments/comments-settings.js";
...
vi.mock("../../../src/lib/comments/comments-rules.js", () => ({ matchRules, matchTrainedTerms }));
...
import { decide } from "../../../src/lib/comments/comments-spam-policy.js";
