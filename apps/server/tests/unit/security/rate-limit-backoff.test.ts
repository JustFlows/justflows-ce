...
import { consumeRateLimit, rateLimitRetryAfter, resetRateLimits } from "../../../src/lib/security/rate-limit.js";
...
describe("bounded memory", () => {
  it("does not grow without limit on attacker-chosen keys", async () => {
    const { rateLimitBucketCount } = await import("../../../src/lib/security/rate-limit.js");
