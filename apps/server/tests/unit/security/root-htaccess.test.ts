...
import { MANAGED_SENTINEL } from "../../../src/lib/settings/managed-config.js";
import { ROOT_HTACCESS_FILE, renderRootHtaccess, writeRootHtaccess } from "../../../src/lib/security/root-htaccess.js";
