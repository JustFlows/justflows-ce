...
const { auditLog, listAuditLog, pruneAuditLog, AUDIT_ACTIONS } = await import("../../../src/lib/security/audit-log.js");
...
describe("retention", () => {
  ...
  it("honours JF_AUDIT_RETENTION_DAYS", async () => {
    ...
    const { auditRetentionDays } = await import("../../../src/lib/security/audit-log.js");
