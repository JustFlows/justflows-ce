...
vi.mock("../../../src/lib/plugins/plugin-runtime.js", () => ({ getRuntimeHooks: vi.fn() }));
import { searchBody } from "../../../src/lib/search/search-db.js";
import { renderSearchPage } from "../../../src/lib/search/search-render.js";
