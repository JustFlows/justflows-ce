...
import { getWorkingRevision, rowToSnapshot, upsertWorkingRevision } from "../../../src/lib/content/content-revisions.js";
import { serializeContentRow } from "../../../src/lib/content/content-api.js";
import {
  deliverScheduleEvents,
  setContentSchedule,
  transitionScheduledContent,
} from "../../../src/lib/content/content-scheduling-db.js";
...
vi.mock("../../../src/lib/plugins/plugin-runtime.js", () => ({ getRuntimeHooks: () => hooks }));
vi.mock("../../../src/lib/content/content-public.js", () => ({ invalidateContentCache: invalidate }));
