...
vi.mock("../../../../src/lib/auth/session.js", async (original) => ({
  ...(await original<typeof import("../../../../src/lib/auth/session.js")>()),
...
vi.mock("../../../../src/lib/search/search-db.js", async (original) => ({
  ...(await original<typeof import("../../../../src/lib/search/search-db.js")>()),
...
vi.mock("../../../../src/lib/settings/site-visibility.js", () => ({
...
const { default: adminRouter } = await import("../../../../src/routes/public/search.js");
const { default: publicRouter } = await import("../../../../src/routes/public/public-api.js");
let server: Server;
let endpoint: string;
beforeAll(async () => {
  const app = express();
