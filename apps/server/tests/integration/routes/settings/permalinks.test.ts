...
import type { PermalinkState, PermalinkTerm } from "../../../../src/lib/navigation/permalinks-db.js";
...
const { createPermalinkRouter } = await import("../../../../src/routes/settings/permalinks.js");
let server: Server;
let origin: string;
beforeAll(async () => {
  const app = express();
