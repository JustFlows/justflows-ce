...
vi.mock("../../../../src/lib/navigation/redirects-db.js", () => ({
  listRedirects: () => list(),
...
const { default: router } = await import("../../../../src/routes/settings/redirects.js");
const { RedirectValidationError } = await import("../../../../src/lib/navigation/redirects.js");
