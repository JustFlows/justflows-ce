...
vi.mock("../../../../src/lib/content/content-scheduling-db.js", async (original) => ({
  ...(await original<typeof import("../../../../src/lib/content/content-scheduling-db.js")>()),
...
vi.mock("../../../../src/lib/auth/access-policy.js", () => ({ userCan: async () => state.allow }));
vi.mock("../../../../src/lib/plugins/plugin-runtime.js", () => ({ getRuntimeHooks: () => ({}) }));
...
import router from "../../../../src/routes/content/content.js";
let server: Server;
let base: string;
beforeAll(async () => {
  const app = express();
