-- Justflows public comments — MariaDB
--
...
-- Kept parallel to the MySQL file; the migration runner treats
-- "duplicate column" / "duplicate key name" as ignorable on re-run.
